  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            const CustomAppBar(tital: 'مجموعات التذكير', isBack: false),
                            ...
                            InkWell(
                              onTap: () {
                                Navigator.pushNamed(
                                  ...
                                  RouteName.kcontact,
                                  arguments: {
                                    'time': provider.groups[i]['time'],
                                    'group_id': provider.groups[i]['id'],
                                    'active': provider.groups[i]['active'],
                                  },
                                );
                              },
                              child: Container(
